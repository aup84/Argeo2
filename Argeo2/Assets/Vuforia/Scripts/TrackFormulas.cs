...
/// </summary>
public class TrackFormulas : MonoBehaviour, ITrackableEventHandler
{
		...
		if (newStatus == TrackableBehaviour.Status.DETECTED || newStatus == TrackableBehaviour.Status.TRACKED ||
			...
			if (mTrackableBehaviour.TrackableName.Equals ("Base")) {
				if (!bas) {
					...
					GameObject.Find ("Arenero").GetComponentInChildren<Transform> ().localScale = new Vector3 (2.55f, 3.87f, 2.09f);
				} 
